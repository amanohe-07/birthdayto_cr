    ...
    <section class="letter-section">
      <div class="container">
        <div class="section-title">
          <div class="badge">✉️ A Letter</div>
          <h2 class="mt-2">Dear CR 💌</h2>
          <div class="divider"></div>
        </div>

        <div class="letter-paper" ref="letterRef">
          <!-- Doodles -->
          ...
          <div class="letter-content">
            ...
            <div class="letter-ps">
              <p><strong>P.S.</strong> — Don't forget to check the Easter Egg page. Just saying. 🥚</p>
            </div>
          </div>
        </div>
      </div>
...
.letter-paper {
  ...
  box-shadow: var(--shadow-lg), inset 0 0 0 1px rgba(255,183,197,0.15);
  padding: 4rem 3.5rem;
  max-width: 740px;
  margin: 0 auto;
